...
$defined_apps = @(
    ...
    ,[AppDefinition]::new("Nano.Text.Editor",               "Standard",   [OSType]::x32, "apps\nano",                                                "*win32*.zip",             "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes, [InstallAction]::RenameLicence, [InstallAction]::RenameFAQ ))
    ...
    ,[AppDefinition]::new("Nano.Text.Editor",               "Standard",   [OSType]::x64, "apps\nano",                                                "*win64*.zip",             "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes, [InstallAction]::RenameLicence, [InstallAction]::RenameFAQ ))
    ...
    ,[AppDefinition]::new("XmlStarlet",                     "Standard",   [OSType]::Any, "apps\xmlstarlet",                                          "*.zip",                   "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes ), @{ [InstallParameter]::ExtractCustomArguments = "-spe" ; [InstallParameter]::ExtractWildcard = "**\*.exe **\readme **\doc\*.txt" })
    ...
    ,[AppDefinition]::new("Wordpad",                        "Extended",   [OSType]::Any, "apps-win\Microsoft\Wordpad",                               "wordpad*.zip",            "win\Wordpad",              [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "wordpad.exe=Wordpad" }) ))
    ,[AppDefinition]::new("Ferrite.Markdown.Editor",        "Extended",   [OSType]::x64, "apps-win\Ferrite",                                         "ferrite*.zip",            "win\Ferrite",              [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "ferrite.exe=Ferrite Markdown Editor" }) ))
    ,[AppDefinition]::new("DependencyWalker",               "Developer",  [OSType]::x32, "apps-win\Microsoft\DependencyWalker",                      "depends*x86*.zip",        "win",                      [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "depends.exe=DependencyWalker" }) ))
    ,[AppDefinition]::new("DependencyWalker",               "Developer",  [OSType]::x64, "apps-win\Microsoft\DependencyWalker",                      "depends*x64*.zip",        "win",                      [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "depends.exe=DependencyWalker" }) ))
    ...
    ,[AppDefinition]::new("NirSoft.Icons.Extract",          "System",     [OSType]::Any, "apps-win\nirsoft",                                         "iconsex*.zip",            "win\nirsoft",              [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes ), [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "iconsext*.exe=Icons Extractor" }) ))
    ,[AppDefinition]::new("NirSoft.Resources.Extract",      "System",     [OSType]::x32, "apps-win\nirsoft",                                         "resourcesext*32*.zip",    "win\nirsoft",              [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes ), [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "resourcesext*.exe=Resources Extractor" }) ))
    ,[AppDefinition]::new("NirSoft.Resources.Extract",      "System",     [OSType]::x64, "apps-win\nirsoft",                                         "resourcesext*64*.zip",    "win\nirsoft",              [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes ), [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "resourcesext*.exe=Resources Extractor" }) ))
    ,[AppDefinition]::new("NirSoft.NETResources.Extract",   "System",     [OSType]::x64, "apps-win\nirsoft",                                         "dotnetresourcesext*.zip", "win\nirsoft",              [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes ), [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "dotnetresourcesext*.exe=.NET Resources Extractor" }) ))
    ...
    ,[AppDefinition]::new("CudaText",                       "Extended",   [OSType]::x64, "apps-win\CudaText",                                        "cudatext*amd64*.zip",     "win\CudaText",             [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ExtractCustomArguments = "-spe" ; [InstallParameter]::ShortcutFilenames = "cudatext.exe=CudaText" }) ))
    ...
    ,[AppDefinition]::new("SmartSystemMenu",                "Standard",   [OSType]::Any, "apps-win\SmartSystemMenu",                                 "Smart*.zip",              "win\SmartSystemMenu",      [InstallType]::ExtractZip, @{ [InstallParameter]::ShortcutFilenames = "Smart*.exe=SmartSystemMenu" ; [InstallParameter]::ShortcutTarget = "shell:startup" } )
    ,[AppDefinition]::new("XnViewMP",                       "Standard",   [OSType]::x64, "apps-win\XnView",                                          "XnViewMP-win*.zip",       "win\XnViewMP",             [InstallType]::ExtractZip, @( [InstallAction]::ClearTargetFolder ), [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ExtractWildcard = "XnViewMP\*.*" ; [InstallParameter]::ExtractCustomArguments = "-r" ; [InstallParameter]::ShortcutFilenames = "XnView*.exe=XnViewMP" }) ))
    ...
    ,[AppDefinition]::new("RapidEE",                        "Advanced",   [OSType]::x64, "apps-win\RapidEE",                                         "RapidEEx64*.zip",         "win\RapidEE",              [InstallType]::ExtractZip, @( [InstallAction]::ClearTargetFolder ), [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "rapid*.exe=RapidEE" }) ))
    ,[AppDefinition]::new("RapidEE",                        "Advanced",   [OSType]::x32, "apps-win\RapidEE",                                         "RapidEEx86*.zip",         "win\RapidEE",              [InstallType]::ExtractZip, @( [InstallAction]::ClearTargetFolder ), [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "rapid*.exe=RapidEE" }) ))
    ...
    ,[AppDefinition]::new("CudaText",                       "Extended",   [OSType]::x64, "apps-win\CudaText",                                        "cudatext*amd64*.zip",     "win\CudaText",             [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ExtractCustomArguments = "-spe" ; [InstallParameter]::ShortcutFilenames = "cudatext.exe=CudaText" }) ))
    ,[AppDefinition]::new("LessMSI",                        "Developer",  [OSType]::Any, "apps-win\LessMSI",                                         "lessmsi*.zip",            "win\LessMSI",              [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "LessMSI*.exe=Less MSI" }) ))
    ,[AppDefinition]::new("NET.Dependency.Graph",           "Developer",  [OSType]::Any, "apps-win\mobzystems",                                      "depgraph*.zip",           "win\MobzSystems",          [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "DepGraph*.exe=NET Dependency Graph:Generate an HTML dependency graph of .NET assemblies" }) ))
    ,[AppDefinition]::new("AutoResXTranslator",             "Developer",  [OSType]::Any, "apps-win\AutoResXTranslator",                              "AutoResxTranslator*.zip", "win\AutoResXTranslator",   [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "AutoResXTranslator*.exe=AutoResXTranslator Resource Translator" }) ))
