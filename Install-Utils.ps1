...
$defined_apps = @(
    ...
    ,[AppDefinition]::new("Awesome Photo Finder",           "Photo",      [OSType]::Any, "apps-win\Awesome Duplicate Photo Finder",                 "awesome*.zip",             "win",                      [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ExtractCommand = "e" ; [InstallParameter]::ShortcutFilenames = "AwesomePhoto*.exe=Awesome Duplicate Photo Finder" }) ))
