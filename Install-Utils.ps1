...
$defined_apps = @(
    ...
    ,[AppDefinition]::new("YAML.Query.Tool",                "Standard",   [OSType]::x32, "apps\yq\x32",                                              "*.zip",                   "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes, [InstallAction]::RenameLicence ), @{ [InstallParameter]::RenameTarget = "yq_*.exe=yq.exe" })
    ,[AppDefinition]::new("YAML.Query.Tool",                "Standard",   [OSType]::x64, "apps\yq\x64",                                              "*.zip",                   "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes, [InstallAction]::RenameLicence ), @{ [InstallParameter]::RenameTarget = "yq_*.exe=yq.exe" })
    ,[AppDefinition]::new("Markdown.Query.Tool",            "Standard",   [OSType]::Any, "apps\mq",                                                  "*.zip",                   "bin",                      [InstallType]::ExtractZip, @( [InstallAction]::RenameReadmes, [InstallAction]::RenameLicence ))
    ...
    ,[AppDefinition]::new("KillerPDF",                      "Extended",   [OSType]::x64, "apps-win\KillerPDF",                                       "KillerPDF*.zip",          "win",                      [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu( @{ [InstallParameter]::ShortcutFilenames = "KillerPDF*.exe=KillerPDF" }) ))
