...
$defined_apps = @(
    ...
    ,[AppDefinition]::new("Ferrite.Markdown.Editor",        "Extended",   [OSType]::Any, "apps-win\Ferrite",                                         "ferrite*.zip",            "win\Ferrite",              [InstallType]::ExtractZip, [hashtable]( ApplyStandardShortcutMenu(@{ [InstallParameter]::ShortcutFilenames = "ferrite.exe=Ferrite Markdown Editor" }) ))
