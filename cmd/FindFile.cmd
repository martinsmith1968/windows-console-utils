...
@IF "%DEBUG%" == "Y" @ECHO ON
SET SEARCHNAME=%SCRIPTNAME%
IF NOT "%OUTPUTFILENAME%" == "" CALL :SETSEARCHNAME "%OUTPUTFILENAME%"
@IF "%DEBUG%" == "Y" @ECHO OFF

REM TODO: Remove NUL when Quiet mode is implemented
Stopwatch start "%SEARCHNAME%" -f > NUL
