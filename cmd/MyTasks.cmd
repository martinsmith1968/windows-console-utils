...
SET TASKCOUNT=0
SET TASKNAME1=ClearTemp
SET TASKNAME2=ClockTime
SET TASKNAME3=PackTFreeLearning
SET TASKNAME4=GoHome
SET TASKNAME5=LunchTime
SET TASKNAME6=TwoMinutesSilence
SET TASKNAME7=GITWIP
...
SET TASKARGS4=/TR "%UTILSROOT%\msbin\TaskbarAlert /Type:WarningText /Text:\"Time to go Home!!!\" /Title:{stime}"  /SC minute  /ST 18:01 /MO 15 /ET 20:01
SET TASKARGS5=/TR "%UTILSROOT%\msbin\TaskbarAlert /Type:WarningText /Text:\"Lunch Time !!!\" /Title:{stime}"      /SC daily   /ST 12:01 /MO 1  /DU 2:00 /RI 15
SET TASKARGS6=/TR "msg "%USERNAME%" \"2 minute silence\""                                                         /SC monthly /ST 10:55 /MO 11 /SD 11/11/2000 /D 11
SET TASKARGS7=/TR "%DEVROOT%\wip.cmd"                                                                             /SC daily   /ST 21:00 /MO 1
