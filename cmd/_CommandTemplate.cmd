...
IF /I "%~1" == "/?" SET USAGE=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "-?" SET USAGE=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "/X" SET DEBUG=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "-X" SET DEBUG=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "/Z" SET DRYRUN=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "-Z" SET DRYRUN=Y&&SHIFT&&GOTO :PARSEOPTS

IF /I "%~1" == "/1" SET MYOPT1=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "/2" SET MYOPT2=Y&&SHIFT&&GOTO :PARSEOPTS
IF /I "%~1" == "/3" SET MYOPT3=Y&&SHIFT&&GOTO :PARSEOPTS
...
IF %ARGPOS% EQU 2 SET COMMAND=%~1&&SHIFT&&GOTO :PARSEOPTS
